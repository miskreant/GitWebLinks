...
export const STRINGS = {
    ...
    getLinkCommand: {
        ...
        copyAsRawUrl: (handlerName: string): string => format('Copy %s URL', handlerName),
        copyAsMarkdownLink: 'Markdown',
        copyAsVSCodeLink: 'VS Code',
        copyAsMarkdownLinkWithoutPreview: 'MD Without Code Block',
        copyAsMarkdownLinkWithPreview: 'MD Code Block',
